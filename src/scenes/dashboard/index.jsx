...
const Dashboard = () => {
  ...
  // Load invoices and admin session
  useEffect(() => {
...
<TextField
  ...
  inputProps={{ style: { letterSpacing: "2px", fontSize: "1rem" } }}
  sx={{
    mb: 3,
    width: "75%",
    "& .MuiOutlinedInput-root": {
      ...
      "& fieldset": {
        borderColor: "#aaa", // optional custom border color
      },
      "&:hover fieldset": {
        borderColor: "#ffb300", // optional hover color
      },
      "&.Mui-focused fieldset": {
        borderColor: "#ffb300", // focus color
      },
    },
    "& .MuiInputLabel-root": {
