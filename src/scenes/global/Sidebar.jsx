      ...
      <ProSidebar collapsed={isCollapsed}>
        <Menu iconShape="square">
          ...
          <Box paddingLeft={isCollapsed ? undefined : "10%"}>
            ...
            {/* ✅ AI Dashboard Link */}
            <Item title="Balance " to="/ai-dashboard" icon={<SmartToyIcon />} selected={selected} setSelected={setSelected} />

            <Typography variant="h6" color={colors.grey[300]} sx={{ m: "15px 0 5px 20px" }}>
              Pages
            </Typography>

            <Item title="User Form" to="/form" icon={<PersonOutlinedIcon />} selected={selected} setSelected={setSelected} />
